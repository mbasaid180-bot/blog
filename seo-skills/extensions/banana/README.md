...
> This extension wraps [Claude Banana](https://github.com/Abderrahim-KHALID/banana-claude)
...
This removes the skill and agent. If you also use [Claude Banana](https://github.com/Abderrahim-KHALID/banana-claude),
