...
Claude SEO is created and maintained by [@Abderrahim-KHALID](https://github.com/Abderrahim-KHALID).
...
| Contributor | PR | What |
|------------|-----|------|
| [@edocltd](https://github.com/edocltd) | [#50](https://github.com/Abderrahim-KHALID/claude-seo/pull/50) | Ukrainian localization |
| [@MalteBerlin](https://github.com/MalteBerlin) | [#45](https://github.com/Abderrahim-KHALID/claude-seo/pull/45) | Sub-skills count correction |
| [@olivierroy](https://github.com/olivierroy) | [#43](https://github.com/Abderrahim-KHALID/claude-seo/pull/43) | Extension install fix |
